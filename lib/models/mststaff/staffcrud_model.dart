class StaffCrudModel {
	...
	StaffCrudModel({required this.alamat, required this.email, 
		required this.gaji, required this.hp, 
		required this.ktp, required this.mjabatanId, this.jabatanDesc, 
		required this.mstaffId, required this.staffNama, 
		required this.uangMakan});

	factory StaffCrudModel.fromJson(Map<String, dynamic> data) =>
		StaffCrudModel(
			alamat: data['alamat']??"",
			email: data['email']??"",
